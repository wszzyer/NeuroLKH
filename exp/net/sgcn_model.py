...
from .sgcn_layers import SparseGCNLayer
from .mlp import MLP
...
class SparseGCNModel(nn.Module):
    ...
    def forward(self, x_nodes, x_edges, edge_index, inverse_edge_index, n_edges):
    ...
    def directed_forward(self, x_nodes, x_edges, edge_index, inverse_edge_index, y_edges1, y_edges2, edge_cw, n_edges):
        ...
        reg_loss = torch.linalg.vector_norm(y_pred_edges, dim=(1, 2, 3), ord=1)
